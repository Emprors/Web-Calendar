...
Theory Create a Spring Boot application object to start working with it. First, create a Spring project using Spring Boot. The following dependencies are already included in our study project in build.gradle file:

spring-boot-starter — the core starter with the autoconfiguration support, logging, and YAML;
spring-boot-starter-web — the starter for building the web, including RESTful, applications using Spring MVC. It uses Tomcat as the default embedded container.
1.2 Objectives
...
Your REST API should have the following features:
